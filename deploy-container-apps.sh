...
# =============================================================================
# Standalone deployment — no K8s cluster required. Reads configuration from
...
#
#   # Option 2: Source the .env.deployed file generated by deploy-aks.sh
...
AZURE_SEARCH_API_KEY="${AZURE_SEARCH_API_KEY:?Set AZURE_SEARCH_API_KEY}"
...
AZURE_COSMOS_KEY="${AZURE_COSMOS_KEY:?Set AZURE_COSMOS_KEY}"
